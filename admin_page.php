...
<div class="Aroba">
   ...
   <form action="" method="post">
    ...
    <div id="mainmain">
    <a href="FoodList_Admin.php"><i class="foods"></i><br>Foods</a>
    <a href="DrinkList_Admin.php"><i class=""></i><br> Drinks</a>
    <a href="SchoolSupplies_Admin.php"><i class=""></i><br> School Supplies</a>
